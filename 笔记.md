...
模板![1586337545630](C:\Users\ADMINI~1\AppData\Local\Temp\1586337545630.png)
...
4. 步骤
   ...
   generate_password_hash----生成安全密码； 

   check_password_hash-----检查安全密码是否正确 
...
- MTV:
  ...
  作用：M和T的桥梁，从M中取出的数据进行计算，返回给T行进展示
